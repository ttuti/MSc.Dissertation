...
# U2.dataset[,Woman.Hse.Head:=0]
# U2.dataset[Sex.Hse.Head=="Female",Woman.Hse.Head:=1,by=key]
# setattr(U2.dataset$Woman.Hse.Head,'label',attr(dataset$Sex.Hse.Head,'label'))
# setattr(U2.dataset$Woman.Hse.Head,'DHS.Code',attr(dataset$Sex.Hse.Head,'DHS.Code'))
# U2.dataset[,Sex.Hse.Head:=NULL]
...
# 
# U2.dataset[,Child.Female:=0]
# U2.dataset[Child.Sex=="Female",Child.Female:=1,by=key]
# setattr(U2.dataset$Child.Female,'label',attr(dataset$Child.Sex,'label'))
# setattr(U2.dataset$Child.Female,'DHS.Code',attr(dataset$Child.Sex,'DHS.Code'))
# U2.dataset[,Child.Sex:=NULL]
...
#U2.dataset[!is.na(Twin)&Twin!="Single birth",Preceding.Birth.Interval:=replicate.values.multiple.births(Preceding.Birth.Interval),by=UQ.No]
...
#Q1.Natural.Social.Selection <- Q1.dataset[complete.cases(Q1.dataset)]
...
write.dta(analysis.dataset,file="E:/SCHOOL/Dissertation/DHS Dataset/Stata Codes/analysis.dataset.dta")
